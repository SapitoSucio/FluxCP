...
//- Sql
Controller::$hostname =     "ec2-35-171-149-143.compute-1.amazonaws.com"          ;   // Mysql Host
Controller::$database =     "rathenadb"           ;   // Database Name
Controller::$username =     "sapito"           ;   // Database Username
Controller::$password =     "PecoPecoCardx1!"           ;   // Database Pass
/// -----------------------------------------------------------------
